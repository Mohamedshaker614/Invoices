    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            <div class="mb-3 mb-xl-0">
                <div class="col-sm-12 ">
                    <a href="{{ route('invoices.create') }}" class="list-group-item list-group-item-action active">
                        إضافة فاتورة</a>
                </div>
            </div>
        </div>
...
@section('content')
    ...
    @if (session()->has('restore'))
        <script>
            window.onload = function() {
                notif({
                    msg: "تم ألغاء أرشفة الفاتورة بنجاح",
                    type: "success"
                })
            }
        </script>
                        ...
                        <tbody>
                            ...
                            @foreach ($invoices as $invoice)
                                ...
                                <tr>
                                    ...
                                    <div class="modal
                                                    fade"
                                        id="delete_invoice" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <form action="{{ route('Archives.destroy', $invoice->id) }}"
                                                        method="post">
                                                        @method('delete')
                                                        @csrf
                                    ...
                                    <div class="modal fade" id="invoice" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">إعادة الفاتورة
                                                    </h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                    <form action="{{ route('restore', $invoice->id) }}" method="post">
                                                        @method('GET')
                                                        @csrf
                                                        <div class="modal-body">
                                                            هل انت متاكد من عملية الإعادة ؟
