                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            <h1 class="invoice-title"
                                style="font-weight: 500px;color:black;display:block;algin-contant:centre">فاتورة تحصيل</h1>
                            <!-- billed-from -->
                        </div><!-- invoice-header -->
                        <div class="billed-from" style="display: block">
                            <p>25 ش صف الشجر - بنها - قليوبية<br>
                                رقم:01220462866<br>
                                Email: {{ auth()->user()->email }}</p>
                        </div>
                        <div class="row mg-t-20" style="color: black">
