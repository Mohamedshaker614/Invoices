...
@section('content')
    ...
    <div class="row row-sm">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span
                                    class="text-white op-7">{{ round((\App\Models\invoice::where('Value_Status', 2)->count() / \App\Models\invoice::count()) * 100, 2) }}
                                    %</span>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                <span
                                    class="text-white op-7">{{ round((\App\Models\invoice::where('Value_Status', 1)->count() / \App\Models\invoice::count()) * 100, 2) }}
                                    %</span>
                            </span>
                        </div>
                    </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-warning-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">إجمالي الفواتير المدفوعة جزئياً</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                            ...
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
                                <span
                                    class="text-white op-7">{{ round((\App\Models\invoice::where('Value_Status', 3)->count() / \App\Models\invoice::count()) * 100, 2) }}
                                    %</span>
                            </span>
                        </div>
                    </div>
    ...
    <div class="row row-sm">
        <div class="col-md-12 col-lg-12 col-xl-7">
            <div class="card">
                <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0" style="width:75%;">
